  ...
  return (
    <main style={{ background: "#071426", color: "#fff", minHeight: "100vh" }}>
      <SEO
        ...
        description="Articles and insights about telehealth, mental health support, prescription savings, veterans healthcare access, and healthcare access for Hampton Roads and nationwide."
        path="/insights"
      />
