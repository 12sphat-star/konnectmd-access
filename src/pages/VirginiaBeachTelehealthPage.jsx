...
export default function VirginiaBeachTelehealthPage() {
  return (
    <main style={styles.page}>
      <SEO
        title="Telehealth Doctor in Virginia Beach, VA | KonnectMD Healthcare Access"
        description="KonnectMD helps Virginia Beach residents explore telehealth doctors, virtual urgent care, prescription savings, mental health support, and healthcare access options."
      ...
      <section style={styles.hero}>
        <div style={styles.container}>
          <div style={styles.grid2}>
            <div>
              <p style={styles.eyebrow}>Virginia Beach Telehealth Access</p>

              <h1 style={styles.h1}>
                Virtual Healthcare Access for{" "}
                <span style={styles.blue}>Virginia Beach Residents</span>
              </h1>

              <p style={styles.p}>
                KonnectMD helps Virginia Beach families, entrepreneurs, and
            ...
            <div style={styles.bigCard}>
              <p style={styles.eyebrow}>Healthcare Access in Virginia Beach</p>
              ...
              <p style={styles.p}>
                From Town Center to Oceanfront, Kempsville, Green Run,
                Princess Anne, and Red Mill — Virginia Beach residents are
                looking for healthcare options that fit modern life.
              </p>
            </div>
          </div>
        </div>
      ...
      <section style={styles.altSection}>
        <div style={styles.container}>
          ...
          <h2 style={styles.h2}>
            What Virginia Beach residents are searching for.
          </h2>

          <div style={styles.grid3}>
            {[
              "Telehealth doctor Virginia Beach",
              "Virtual urgent care Virginia Beach",
              "Doctor without insurance Virginia Beach",
              "Affordable healthcare Virginia Beach",
              "Prescription savings Virginia Beach",
              "Mental health support Virginia Beach",
            ].map((item) => (
      ...
      <section style={styles.altSection}>
        <div style={{ ...styles.container, maxWidth: "920px" }}>
          <p style={styles.eyebrow}>Questions Virginia Beach Residents Ask</p>
          ...
          {[
            [
              "Can I use KonnectMD in Virginia Beach?",
              "Yes. KonnectMD can help Virginia Beach residents explore healthcare access, telehealth, prescription savings, and wellness support.",
            ],
            [
      ...
      <section style={styles.cta}>
        <div style={{ ...styles.container, maxWidth: "820px" }}>
          <p style={styles.eyebrow}>Virginia Beach Healthcare Access</p>
